...
1.  `fromaccount` = Υποχρεωτική Σειρά Χαρακτήρων: Ο λογαριασμός από τον οποίο θα γίνει η αγορά των εισιτηρίων (π.χ. "προκαθορισμένος").
2.  `spendlimit` = Υποχρεωτικός Αριθμός: Περιορισμός του ποσού που θα ξοδέψετε στο εισιτήριο (π.χ. 50).
3.  `minconf` = Προαιρετικός Αριθμός: Ελάχιστος αριθμός επιβεβαιώσεων μπλοκ που απαιτούνται (π.χ. 1).
4.  `ticketaddress` Προαιρετική Σειρά Χαρακτήρων: Η διεύθυνση εισιτηρίου στην οποία δίνονται τα δικαιώματα ψήφου
5.  `numtickets` = Προαιρετικός Αριθμός: Ο αριθμός των εισιτηρίων προς ταυτόχρονη αγορά (π.χ. 1)
6.  `pooladdress` = Προαιρετική Σειρά Χαρακτήρων: Η διεύθυνση στην οποία θα καταβληθούν τα τέλη της συγκέντρωσης
7.  `poolfees` = Προαιρετικός Αριθμός: Το ποσοστό των τελών που θα πρέπει να καταβληθούν στην συγκέντρωση κλειδώματος νομισμάτων (π.χ. 5)
