...
New blocks are discovered by the PoW miners roughly every 5 minutes, and each time this occurs some new decred is created.  This "block reward" is split three ways:
