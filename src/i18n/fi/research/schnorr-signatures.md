...
Schnorr signatureja on ehdotettu Bitcoinille. Niitä on myös käytetty laajalti muissa kryptovaluutoissa, kuten Nxt:ssä ja CrypoNotessa. Yksinkertaisimmillaan Schnorr signature ECDSA kryptojärjestelmää voidaan kuvailla seuraavasti:
...
5. Allekirjoitus on \((r,s)\), ja vahvistus yksinkertaisesti \(H(M || r) == hQ + sG\).
