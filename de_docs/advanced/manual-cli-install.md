...
1. Download the correct file:
    ...
    For 32-bit computers, download the `decred-darwin-386-v1.0.5.tar.gz` file. <br />
...
1. Download the correct file:
    ...
    For 32-bit computers, download the `decred-linux-386-v1.0.5.tar.gz` file. <br />
    For 64-bit computers, download the `decred-darwin-amd64-v1.0.5.tar.gz` file. <br />
    For 32-bit ARM computers, download the `decred-linux-arm-v1.0.5.tar.gz` file. <br />
...
1. Download the correct file:
    ...
    For 32-bit computers, download the `decred-windows-386-v1.0.5.zip` file. <br />
