# <i class="fa fa-exchange"></i> Ottenere DCR

---

## <i class="fa fa-info-circle"></i> Overview

In questo articolo vengono descritti alcuni modi in cui un utente può acquisire monete Decred.

The five basic ways are:

* Acquisto Decred per BTC attraverso un Exchange
* PoW Mine per Decred
* PoS Mine per Decred (questo richiede di avere già un Decred)
