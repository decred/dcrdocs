# <i class="fa fa-exchange"></i> Mendapatkan DCR

---

## <i class="fa fa-info-circle"></i> Overview

Artikel ini membahas beberapa cara pengguna dapat memperoleh koin Decred.

The five basic ways are:

* Pembelian Decred untuk BTC melalui bursa
* Tambang PoW untuk Decred
* Tambang PoS untuk Decred (ini mengharuskan Anda untuk memiliki beberapa Decred)
