# <i class="fa fa-exchange"></i> Отримання DCR

---

## <i class="fa fa-info-circle"></i> Overview

У цій статті розглядаються деякі способи, за допомогою яких користувач може придбати 
монети Decred.

The five basic ways are:

* Покупка Decred за BTC через біржу
* PoW-майнинг для Decred
* PoS-майнинг для Decred (для цього потрібно, щоб Ви вже мали певну кількість Decred)
