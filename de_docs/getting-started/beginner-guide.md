...
**Paymetheus**: The only Windows GUI client as of v1.0.3. <br />
...
**Decrediton**: Cross-platform GUI client as of v1.0.3.
...
* [Decrediton (ALPHA)](https://github.com/decred/decrediton)
