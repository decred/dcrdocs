...
This guide assumes you already have an active wallet and have purchased tickets. If not, please follow the [Voting Preparation](agenda-voting.md#voting-preparation) guide.
