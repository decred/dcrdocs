...
The choice your ticket makes depends on the voting preference (Yes/No/Abstain) that is set when it is selected to vote. This means you can change the preference for all your live tickets at any time while the agenda is running, and they will vote accordingly.
