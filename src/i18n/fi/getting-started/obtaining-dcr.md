# <i class="fa fa-exchange"></i> DCR:n Hankkiminen

---

## <i class="fa fa-info-circle"></i> Overview

Tässä artikkelissa käsitellään eri tapoja joilla käyttäjä voi hankkia itselleen Decred-
kolikoita.

The five basic ways are:

* Osta Decredia BTC:llä kauppapaikassa
* PoW-louhi Decrediä
* PoS-louhi Decrediä (tämä vaatii että sinulla on jo hallussasi jokin summa Decrediä)
