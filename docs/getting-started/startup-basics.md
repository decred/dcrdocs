...
The [dcrinstall](user-guides/cli-installation.md) installation method automatically creates configuration files, with the [minimum configuration settings](../advanced/manual-cli-install.md#minimum-configuration) already enabled. 
