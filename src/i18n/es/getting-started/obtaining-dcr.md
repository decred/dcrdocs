# <i class="fa fa-exchange"></i> Obteniendo DCR

---

## <i class="fa fa-info-circle"></i> Overview

En este artículo se describen algunas de las formas en que un usuario puede adquirir Decred
monedas

The five basic ways are:

* Compre Decred para BTC a través de un Exchange
* Minar PoW para Decred
* Mine PoS para Decred (esto requiere que usted ya tenga algunos Decred)
