...
To continue on The Golden Path, visit the [dcrctl Basics](/getting-started/user-guides/dcrctl-basics.md) guide to learn how to unlock your wallet, send and receive DCR using `dcrctl`, checking your balance, and checking various network stats.
