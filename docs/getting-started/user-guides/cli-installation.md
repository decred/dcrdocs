...
1. Download the correct file:
    ...
    For 32-bit computers, download the `dcrinstall-darwin-386-v1.0.3` file. <br />
    For 64-bit computers, download the `dcrinstall-darwin-amd64-v1.0.3` file.
...
2. Make dcrinstall-darwin-xxxx-vx.x.x an executable within your terminal, and run it:
    ...
    `cd ~/Downloads/` <br />
    `chmod u+x dcrinstall-darwin-amd64-v1.0.3` <br />
    `./dcrinstall-darwin-amd64-v1.0.3`
...
1. Download the correct file:
    ...
    For 32-bit computers, download the `dcrinstall-linux-386-v1.0.3` file. <br />
    For 64-bit computers, download the `dcrinstall-linux-amd64-v1.0.3` file. <br />
    For 32-bit ARM computers, download the `dcrinstall-linux-arm-v1.0.3` file. <br />
    For 64-bit ARM computers, download the `dcrinstall-linux-arm64-v1.0.3` file.
...
2. Make dcrinstall-linux-xxxx-vx.x.x an executable within your terminal, and run it:
    ...
    `cd ~/Downloads/` <br />
    `chmod u+x dcrinstall-linux-amd64-v1.0.3` <br />
    `./dcrinstall-linux-amd64-v1.0.3` 
...
1. Download the correct file:
    ...
    For 32-bit computers, download the `dcrinstall-windows-386-v1.0.3.exe` file. <br /> 
    For 64-bit computers, download the `dcrinstall-windows-amd64-v1.0.3.exe` file. <br />
