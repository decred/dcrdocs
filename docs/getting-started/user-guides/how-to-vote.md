...
This guide assumes you already have an active wallet and have purchased tickets. If not, please follow the [Voting Preperation](https://docs.decred.org/getting-started/user-guides/agenda-voting/#voting-preparation) guide.
