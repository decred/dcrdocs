# <i class="fa fa-exchange"></i> Αποκτώντας DCR

---

## <i class="fa fa-info-circle"></i> Overview

Αυτό το άρθρο περιγράφει μερικούς από τους τρόπους με τους οποίους ένας χρήστης μπορεί να αποκτήσει νομίσματα
Decred.

The five basic ways are:

* Αγορά Decred από BTC μέσω Συναλλακτήριου
* PoW Mine για Decred
* PoS Mine για Decred (αυτό απαιτεί το να έχετε ήδη κάποια Decred)
