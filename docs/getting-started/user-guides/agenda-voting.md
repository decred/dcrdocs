...
To participate in voting, you first need a wallet. If you don't have one already, visit the [Beginner Guide](../beginner-guide.md), choose a wallet, and follow the installation and setup guides.
